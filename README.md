...
### INSTALL SCRIPT
<pre><code>apt install -y && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/albarra22/v4/main/setup.sh && chmod +x setup.sh && ./setup.sh
</code></pre>
